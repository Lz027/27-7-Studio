...
const TYPE_ICON: Record<string, React.ReactNode> = {
  ...
  Guide: <BookOpen className="h-4 w-4" />,import { useState } from "react";
import { ArrowUpRight, FileText, BookOpen } from "lucide-react";
import { site } from "@/lib/site-content";
import { useInView } from "@/hooks/useInView";
...
export function Publications() {
  ...
  return (
    <section id="publications" className="px-4 py-10 md:px-6 md:py-12 border-t border-border/40">
            ...
            return (
              ...
              >
                ...
                <div className="mx-4 mb-3 md:hidden">
                  <div className="rounded-lg border border-border/40 bg-background/90 p-3">
                ...
                {/* Desktop: hover description panel */}
                <div
