    ...
    items: [
      {
        year: "2024",
        name: "Shoseki",
        tags: ["Product Design", "Frontend", "Curation"],
        description:
          "A curated platform bringing together 250 tools to solve the problem of scattered, hard-to-find useful resources.",
      ...
      },
      {
        ...
        description:
          "Technical research reflecting a structured approach to problem-solving and systems thinking.",
        link: "#",
      },
      {
        year: "2025",
